...
// @ts-expect-error ts-migrate(6142) FIXME: Module '../components/AggregationFilters' was reso... Remove this comment to see the full error message
...
export const dispatchToProps = (
  ...
  onAggregationChange(aggregationKey: any, selections: any) {
    dispatch(
